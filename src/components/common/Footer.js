...
const FooterStyle = styled.footer`
  ...
  div.footer-rowbottom {
    border-top: 1px px solid #ececec;
    padding-top: 25px;
    width: 90%;
    max-width: 1060px;
    margin: 0 auto 18px;
...
function Footer() {
  return (
    <FooterStyle>
      ...
      <div className="footer-rowbottom">
        <p className="rowbottom-text">
          (주)원티드랩 (대표이사:이복기) | 서울특별시 송파구 올림픽로 300
          롯데월드타워 35층 | 통신판매번호 : 2020-서울송파-3147
          <br />
          유료직업소개사업등록번호 : (국내) 제2020-3230259-14-5-00018호 |
          사업자등록번호 : 299-86-00021 | 02-539-7118<br></br>© Wantedlab, Inc.
        </p>
      </div>
    </FooterStyle>
  );
